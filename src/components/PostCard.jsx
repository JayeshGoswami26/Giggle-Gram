...
import ImagePreviewSkeleton from './Skeleton/ImagePreviewSkeleton';
  ...
  return (
    <Link to={`/post/${$id}`}>
        ...
        <div className="flex items-center gap-3">
            ...
            {isImageLoading ? <ImagePreviewSkeleton/>  : '' }
            <img onLoad={()=>setIsImageLoading(false)} src={appwriteService.getFilePreview(featuredImage)} alt={title}
                className={`object-cover rounded-xl w-[20rem] ${isImageLoading ? 'hidden' : ''} `} />
            </div>
